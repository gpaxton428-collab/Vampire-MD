...
export default {
  name: 'removesudo',
  description: 'Revoke owner-level access from a number',
  category: 'owner',
  ownerOnly: true,
  async execute(sock, msg, args, prefix, ctx = {}) {
    ...
    if (!number) return sock.sendMessage(chatId, { text: `❌ Usage: ${prefix}removesudo <number>` }, { quoted: msg });
    let sudo = [];
    ...
    await sock.sendMessage(chatId, { text: `✅ ${number} removed from sudo.` }, { quoted: msg });
  }
};
