export default {
  ...
  async execute(sock, msg, args, prefix) {
    ...
    const roasts = [
      ...
      "Your cooking tastes like regret.",
      "You're the reason they have warning labels.",
      "Your jokes make me want to punch myself.",
      "You're like a dark cloud on a sunny day.",
      "Your fashion sense is a crime against humanity.",
      "You have the personality of a cardboard box.",
      "You're the definition of mediocre.",
      "Your dreams are as empty as your brain."
    ];
